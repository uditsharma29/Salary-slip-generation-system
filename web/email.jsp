...
<head>
        ...
        #mailing 
 {
    ...
    <body onload="disablebutton()">
        ...
        <div id="outer">
            Select All <input type="checkbox"  name="select" id="check" onclick="checkAll()"> <span id="totalEntries"></span><br>
        <div id="mailing">
            ...
            int count = 0; //for the purpose of counting
...
<div id="totalCount">Total no. of entries : <%= count %></div>
<input type="hidden" name="month" value="<%= month%>">
<input type="hidden" name="session" value="<%= sessionlocal%>">

<div>Total no. of entries are </div>        
        </div>
            <br>
